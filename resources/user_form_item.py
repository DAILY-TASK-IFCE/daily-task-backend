...
from schemas.user_form_item import (
    UserFormItemQueryParamsSchema,
    UserFormItemResponseSchema,
    UserFormItemParamsSchema,
)
...
class UserFormItemId(ResourceModel):
    ...
    def delete(self, id):
        ...
        return {
            "message": "Item de formulário removido com sucesso de um usuário."
        }, 200
